...
def addArg(parser):
    ...
    parser.add_argument("--generate-result", default="/home/hongyining/s_link/dualEnc_virtual/fairseq/infer/final/generate-test.txt")
    parser.add_argument("--target", default="/home/hongyining/s_link/dualEnc_virtual/AMR2.0/test.sequence.target")
    parser.add_argument("--output-dir", default="/home/hongyining/s_link/dualEnc_virtual/fairseq/infer/final")
