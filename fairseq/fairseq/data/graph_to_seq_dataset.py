...
def collate(
    ...
    def merge(key, left_pad, move_eos_to_beginning=False, pad_to_length=None):
        if key == "graph_structures" or key.find("node") != -1 or key.find("edge") != -1:
...
class GraphToSeqDataset(FairseqDataset):
    """
    ...
    def __init__(
        ...
        self.src_dict = add_dict
        self.tgt_dict = add_dict
        ...
        self.eos = eos if eos is not None else add_dict.eos()
    ...
    def __getitem__(self, index):
        ...
        example = {
            ...
            "source": src_item,
            "target": tgt_item,
            "graph_structures": self.graph_structures[index] - 3,
            "nodes": self.nodes[index],
            "edges": self.edges[index],
            "nodes_info": self.nodes_info[index] - 3,
            "edges_info": self.edges_info[index] - 3,
        }
        if self.align_dataset is not None:
    ...
    def collater(self, samples, pad_to_length=None):
        ...
        if self.src_lang_id is not None or self.tgt_lang_id is not None:
            logger.warning("not implemented yet! /home/hongyining/s_link/dualEnc_virtual/fairseq/fairseq/tasks/graph_to_seq.py, collater")
            exit(-1)
