...
CUDA_VISIBLE_DEVICES=0 fairseq-generate $DATA_BIN \
    ...
    --post-process \
    --remove-bpe \
    --results-path /home/hongyining/s_link/dualEnc_virtual/fairseq/infer/AMR2.0+pretrain+bart \
    --find-unused-parameters;

python infer.py \
    --generate-result /home/hongyining/s_link/dualEnc_virtual/fairseq/infer/AMR2.0+pretrain+bart/generate-test.txt \
    --data-path /home/hongyining/s_link/dualEnc_virtual/AMR2.0 \
    --output-dir /home/hongyining/s_link/dualEnc_virtual/fairseq/infer/AMR2.0+pretrain+bart